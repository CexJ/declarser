...
import mapper.MapperDeclarserFactoryImpl;
...
public class MapperExample {
    ...
    @Test
    public void test(){
        final var factory = new MapperDeclarserFactoryImpl();
        final var declarser = factory.declarserOf(From.class, To.class).getValue();
