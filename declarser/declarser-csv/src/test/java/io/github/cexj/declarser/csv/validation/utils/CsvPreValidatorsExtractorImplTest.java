...
import io.github.cexj.declarser.csv.validation.utils.utils.ArgsValidatorClass1;
...
public class CsvPreValidatorsExtractorImplTest {
    ...
    public void testFlyWeightPattern(){
        Assertions.assertEquals(CsvPreValidatorsExtractor.getInstance(), CsvPreValidatorsExtractor.getInstance());
    }
